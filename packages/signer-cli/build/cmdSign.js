...
import { assert, hexToU8a, isHex, u8aToHex } from '@axia-js/util';
import { cryptoWaitReady, keyExtractSuri, mnemonicValidate } from '@axia-js/util-crypto';
...
export default async function cmdSign(_, suri, type, [payload]) {
  validateSeed(suri);
